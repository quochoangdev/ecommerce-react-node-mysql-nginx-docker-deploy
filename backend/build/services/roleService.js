...
var readRolesWithPagination = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(page, limit) {
    var offset, _yield$db$Role$findAn, count, rows, totalPages, data;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          offset = (page - 1) * limit;
          _context2.next = 4;
          return _index["default"].Role.findAndCountAll({
            offset: offset,
            limit: limit,
            attributes: ["id", "url", "description"],
            order: [["description", "ASC"]]
        ...
        case 4:
          _yield$db$Role$findAn = _context2.sent;
          count = _yield$db$Role$findAn.count;
          rows = _yield$db$Role$findAn.rows;
  ...
  return function readRolesWithPagination(_x, _x2) {
...
var createRole = /*#__PURE__*/function () {
  ...
  return function createRole(_x3) {
...
module.exports = {
  readRole: readRole,
  readRolesWithPagination: readRolesWithPagination,
