...
var _UploadCloud = require("../utility/UploadCloud");
...
var checkEmailExist = /*#__PURE__*/function () {
  ...
  return function checkEmailExist(_x4) {
...
var checkPhoneExist = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(phone) {
    var user;
  ...
  return function checkPhoneExist(_x5) {
...
var hashUserPassword = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          ...
          return _context6.abrupt("return", hashPassword);
        case 3:
        case "end":
  ...
  return function hashUserPassword(_x6) {
  ...
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(data) {
    ...
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        ...
        case 6:
          _context7.next = 8;
          return checkPhoneExist(data.phone);
        case 8:
          isPhoneExist = _context7.sent;
          if (!isPhoneExist) {
            _context7.next = 11;
            break;
          }
...
var updateUser = /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(data) {
    var user, uploadImage, _updateUser, id, lastName, firstName, phone, cities, districts, address, sex, image, groupWithRoles, payload, token;
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        ...
        case 3:
          ...
          if (data !== null && data !== void 0 && data.image.startsWith("https://res.cloudinary.com")) {
            _context8.next = 10;
            break;
          }
          _context8.next = 9;
          return (0, _UploadCloud.UploadCloud)(data.image, "imageAvatar");
        case 9:
          uploadImage = _context8.sent;
        case 10:
          _context8.next = 12;
          return user.update({
            lastName: data.lastName,
        ...
        case 12:
          _updateUser = _context8.sent;
          id = _updateUser.id, lastName = _updateUser.lastName, firstName = _updateUser.firstName, phone = _updateUser.phone, cities = _updateUser.cities, districts = _updateUser.districts, address = _updateUser.address, sex = _updateUser.sex, image = _updateUser.image;
          _context8.next = 16;
          return (0, _JWTService.getGroupWithRoles)(_updateUser);
        case 16:
          groupWithRoles = _context8.sent;
          payload = {
            user: {
              id: id,
              firstName: firstName,
          ...
          _context8.next = 20;
          return (0, _JWTAction.createJWT)(payload);
        case 20:
...
var deleteOneUser = /*#__PURE__*/function () {
  ...
  return function deleteOneUser(_x9) {
