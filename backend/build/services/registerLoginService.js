...
var hashUserPassword = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          return _context3.abrupt("return", hashPassword);
        case 3:
        case "end":
  ...
  return function hashUserPassword(_x3) {
...
var checkPassword = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(inputPassword, hashPassword) {
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          return _context5.abrupt("return", _bcryptjs["default"].compareSync(inputPassword, hashPassword));
        case 1:
        case "end":
  ...
  return function checkPassword(_x5, _x6) {
...
var handleLoginUser = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(data) {
    var user, isCorrectPassword, _user$dataValues, id, lastName, firstName, phone, cities, districts, address, sex, image, groupWithRoles, payload, token;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 3:
          ...
          _context6.next = 7;
          return checkPassword(data.password, user.password);
        case 7:
          isCorrectPassword = _context6.sent;
          if (!isCorrectPassword) {
            _context6.next = 20;
            break;
          }
          _user$dataValues = user.dataValues, id = _user$dataValues.id, lastName = _user$dataValues.lastName, firstName = _user$dataValues.firstName, phone = _user$dataValues.phone, cities = _user$dataValues.cities, districts = _user$dataValues.districts, address = _user$dataValues.address, sex = _user$dataValues.sex, image = _user$dataValues.image;
          _context6.next = 12;
          return (0, _JWTService.getGroupWithRoles)(user);
        case 12:
          groupWithRoles = _context6.sent;
          payload = {
            user: {
              id: id,
              firstName: firstName,
  ...
  return function handleLoginUser(_x7) {
