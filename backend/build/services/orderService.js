...
var readOrder = /*#__PURE__*/function () {
  ...
  return function readOrder(_x) {
    return _ref.apply(this, arguments);
  };
}();
var readOrderWithPagination = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(page, limit, idUser) {
    var offset, _yield$db$Order$findA, count, rows, totalPages, data;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          offset = (page - 1) * limit;
          _context2.next = 4;
          return _index["default"].Order.findAndCountAll({
            offset: offset,
            limit: limit,
            attributes: ["id", "userId", "status", "createdAt"],
            order: [["id", "ASC"]],
        ...
        case 4:
          ...
          rows = _yield$db$Order$findA.rows;
  ...
  return function readOrderWithPagination(_x2, _x3, _x4) {
...
var createOrder = /*#__PURE__*/function () {
  ...
  return function createOrder(_x5) {
...
var deleteOrder = /*#__PURE__*/function () {
  ...
  return function deleteOrder(_x6) {
    return _ref4.apply(this, arguments);
  };
}();
module.exports = {
  readOrder: readOrder,
  readOrderWithPagination: readOrderWithPagination,
